...
//		System.out.println("Path "+sec_file.getPath());
//		System.out.println("Path "+sec_file.getAbsolutePath());
//		System.out.println(sec_file.isDirectory());
//		System.out.println(sec_file.isFile());
//		System.out.println(sec_file.canExecute());
//		System.out.println(sec_file.canRead());
//		System.out.println(sec_file.canWrite());
//		System.out.println(sec_file.length());
//		System.out.println(sec_file.exists());
//		String name = sec_file.getName();
//		System.out.println(name);
//		xl.createNewFile();
//		//sec_file.compareTo("D:/Eclipse_workspace/FileHandlingDemo/Java/Sample.txt");
